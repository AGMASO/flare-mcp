...
export const GetFlrUsdPriceSchema = z.object({
  pricefeed: z.string().optional().describe("Get FLR/USD price"),
});

export const GetBtcUsdPriceSchema = z.object({
  pricefeed: z.string().optional().describe("Get BTC/USD price"),
});

export const GetEthUsdPriceSchema = z.object({
  pricefeed: z.string().optional().describe("Get ETH/USD price"),
});
